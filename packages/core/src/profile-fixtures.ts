...
export const browseProfileFixtures: BrowseProfileFixture[] = [
  {
    ...
    draft: mergeProfileDraft({
      ...
      horoscope: {
        ...
        birthPlace: "Colombo",
        normalizedBirthPlace: "Colombo, Sri Lanka",
  ...
  },
  {
    ...
    draft: mergeProfileDraft({
      ...
      horoscope: {
        ...
        birthTimeAccuracy: "exact",
        birthPlace: "Kandy",
        normalizedBirthPlace: "Kandy, Sri Lanka",
        birthLatitude: 7.2906,
        birthLongitude: 80.6337,
        birthTimeZone: "Asia/Colombo",
      },
      family: {
        education: "Doctorate",
  ...
  },
  {
    ...
    draft: mergeProfileDraft({
      ...
      horoscope: {
        ...
        birthTimeAccuracy: "exact",
        birthPlace: "Galle",
        normalizedBirthPlace: "Galle, Sri Lanka",
        birthLatitude: 6.0535,
        birthLongitude: 80.221,
        birthTimeZone: "Asia/Colombo",
      },
      family: {
        education: "Bachelor's degree",
  ...
  },
  {
    ...
    draft: mergeProfileDraft({
      ...
      horoscope: {
        ...
        birthTimeAccuracy: "exact",
        birthPlace: "Matara",
        normalizedBirthPlace: "Matara, Sri Lanka",
        birthLatitude: 5.9549,
        birthLongitude: 80.555,
        birthTimeZone: "Asia/Colombo",
      },
      family: {
